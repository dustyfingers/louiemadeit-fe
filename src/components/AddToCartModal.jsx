...
const AddToCartModal = ({ track, cartItems, dispatch }) => {
    ...
    return (
        <div
            ...
            id={`add${track.trackName.replace(/ /g, '_')}ToCartModal`}
            tabIndex="-1"
                ...
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">
                            Choose License Type - {track.trackName}
                        </h5>
                        <button
                            type="button"
                            className="btn-close"
                    ...
                    <div className="modal-body container">
                        <div className="row">
                            ...
                            <span
                                type="button"
                                className="add-to-cart-btn col"
                                onClick={() =>
                                    handleAddToCartButtonClicked(
                                        track.prices.exclusiveStripePrice,
                        ...
                        <div className="row">
                            ...
                            <span
                                ...
                                onClick={() =>
                                    handleAddToCartButtonClicked(
                                        track.prices.leaseStripePriceMaster,
                                        track.prices.leasePriceStems
                                    )
                                }
                            >
                                <img
                        ...
                        <div className="row">
                            ...
                            <span
                                ...
                                onClick={() =>
                                    handleAddToCartButtonClicked(
                                        track.prices.leaseStripePriceStems,
                                        track.prices.leasePriceMaster
                                    )
                                }
                            >
                                <img
