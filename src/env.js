...
switch (env) {
    case 'local':
        ...
        stripePk =
            'pk_test_51Iay6NLYNexBDWiNibCpA8UpN74X44ZhbJaEVHD76t2ERmHgNn3XotNlNCDkac5tG63yriJM4IkHKDkoEpL1LsGB00rtH51v6B';
        break;
    case 'test':
    ...
    case 'prod':
        ...
        stripePk =
            'pk_live_51Iay6NLYNexBDWiNEB5fvxUoCioW5N2gkflsWJYc1QlzGHX2kcPi3eavIWKJHkaIMfbHIx1Z3XVxY7YnXlJf5sd800AhDe41bU';
        break;
    //  default to test env
    default:
        apiLink = 'https://louiemadeit-test.herokuapp.com';
